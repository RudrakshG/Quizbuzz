class Form {
    ...
    display(){
      ...
      this.Age.position(width/2 - 40 , height/1.9 - 80);
      ...
      this.button.mousePressed(()=>{
        this.input.hide();
        this.button.hide();
        this.button.name = this.input.value();
        //playerCount+=1;
        //this.button.index = playerCount;
       // this.button.update();
        //this.button.updateCount(playerCount);
        this.greeting.html("Hello " + this.button.name)
        this.greeting.position(width/2 - 70, height/4);

        this.button.hide();
        //this.greeting.html("Hello ");
        //Creating first info
        oneinf = createSprite(width / 2 + 30, height / 2);
